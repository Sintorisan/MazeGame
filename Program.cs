...
MapGenerator _fieldGen = new MapGenerator();
var playingField = MapGenerator.GenerateMap(new MapOptions
{
    MapSize = [5, 5],
    MaxMonsters = 5,
    MaxTreasures = 10
...
for (int i = 0; i < playingField.Rooms!.GetLength(0); i++)
{
    var room = playingField.Rooms[0, i];
    Console.WriteLine();
    Console.WriteLine("-------------------------------------------------------------------------------");
    Console.WriteLine("Room " + i);
    Console.WriteLine();
    Console.WriteLine("room type:" + room.RoomType.ToString());
    Console.WriteLine(room.Scenery.RoomScenery);
    foreach (var wall in room.Walls)
    {
        Console.WriteLine(wall.Direction);
        Console.WriteLine("wall walltype: " + wall.WallType.ToString());
        Console.WriteLine("view wallrtype: " + wall.View.WallType.ToString());
        Console.WriteLine(wall.View.Ascii);
    }
}
